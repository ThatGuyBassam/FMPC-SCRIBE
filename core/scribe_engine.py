...
def process_file(file_path, name):
    ...
    # Run transcriber — 3h timeout (covers 2h lecture + cleaning + VRAM retries)
    ...
    try:
        ...
        log.error("Transcriber timed out after 3 hours — CUDA may have hung. Killing process.")
        return
    ...
    # Run processor — 1h timeout (covers Ollama correction + filter passes)
    try:
        ...
        log.error("Processor timed out after 1 hour — Ollama may have hung.")
        return
